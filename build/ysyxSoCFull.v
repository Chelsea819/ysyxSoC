...
module CPU(	// src/CPU.scala:33:9
  ...
  ysyx_23060025 cpu (	// src/CPU.scala:38:21
    .clock                   (clock),
    .reset                   (reset),
...
module mem_2048x32(	// rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26
  ...
  //   if (W0_en) begin	// rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26
  //     $display("waddr: 000 wdata: %x", Memory[0]);	// rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26
  //     $display("waddr: 001 wdata: %x", Memory[1]);	// rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26
  //     $display("waddr: 002 wdata: %x", Memory[2]);	// rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26
  //   $display("waddr: 003 wdata: %x", Memory[3]);	// rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26
  //   $display("waddr: 004 wdata: %x", Memory[4]);	// rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26
  //   $display("waddr: 005 wdata: %x", Memory[5]);	// rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26
  //   $display("waddr: 006 wdata: %x", Memory[6]);	// rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26
  //   $display("waddr: 007 wdata: %x", Memory[7]);	// rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26
  //   $display("waddr: 008 wdata: %x", Memory[8]);	// rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26
  //   $display("waddr: 009 wdata: %x", Memory[9]);	// rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26
  //   $display("waddr: 00a wdata: %x", Memory[10]);	// rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26
  //   $display("waddr: 00b wdata: %x", Memory[11]);	// rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26
  //   $display("waddr: 00c wdata: %x", Memory[12]);	// rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26
  //   $display("waddr: 00d wdata: %x", Memory[13]);	// rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26
  //   $display("waddr: 00e wdata: %x", Memory[14]);	// rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26
  //   $display("waddr: 00f wdata: %x\n", Memory[15]);	// rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26
  //   end
  // end
  ...
  always @(posedge W0_clk) begin	// rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26
    // $display("W0_addr: %x, W0_mask: %b wdata: %x\n", W0_addr,W0_mask, W0_data);	// rocket-chip/src/main/scala/util/DescribedSRAM.scala:17:26
...
module APBSDRAM(	// src/device/SDRAM.scala:87:9
  ...
  output [12+1:0] sdram_bundle_a,	// src/device/SDRAM.scala:89:26
...
module ysyxSoCASIC(	// src/SoC.scala:59:9
  ...
  output [12+1:0] sdram_a,	// src/SoC.scala:89:19
...
module ysyxSoCFull(	// src/SoC.scala:111:9
  ...
  wire [12+1:0] _asic_sdram_a;	// src/SoC.scala:107:24
  ...
  sdram0_1 sdram0_1 (	// src/SoC.scala:145:23
    .clk (_asic_sdram_clk),	// src/SoC.scala:107:24
    .cke (_asic_sdram_cke),	// src/SoC.scala:107:24
    .cs  (_asic_sdram_cs | ~(_asic_sdram_a[13] == 1 || {_asic_sdram_cs, _asic_sdram_ras, _asic_sdram_cas, _asic_sdram_we} == 0)),	// src/SoC.scala:107:24
    .ras (_asic_sdram_ras),	// src/SoC.scala:107:24
    .cas (_asic_sdram_cas),	// src/SoC.scala:107:24
    .we  (_asic_sdram_we),	// src/SoC.scala:107:24
    .a   (_asic_sdram_a[12:0]),	// src/SoC.scala:107:24
  ...
  sdram1_1 sdram1_1 (	// src/SoC.scala:145:23
    .clk (_asic_sdram_clk),	// src/SoC.scala:107:24
    .cke (_asic_sdram_cke),	// src/SoC.scala:107:24
    .cs  (_asic_sdram_cs | ~(_asic_sdram_a[13] == 1 || {_asic_sdram_cs, _asic_sdram_ras, _asic_sdram_cas, _asic_sdram_we} == 0)),	// src/SoC.scala:107:24
    .ras (_asic_sdram_ras),	// src/SoC.scala:107:24
